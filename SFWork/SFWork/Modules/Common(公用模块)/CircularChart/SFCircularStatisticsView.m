...
@implementation SFCircularStatisticsView

- (SFChartTitleView *)chartTitleView{
    
    if (!_chartTitleView) {
        
        _chartTitleView = [SFChartTitleView shareSFChartTitleView];
    }
    return _chartTitleView;
}
...
- (void)setDrawUI {
    ...
    self.chartTitleView.layer.cornerRadius = 45;
    self.chartTitleView.clipsToBounds = YES;
    [self addSubview:self.chartTitleView];
...
- (void)addCenterLabel{
    ...
    if (_percent == 1) {
        ...
        arcColor = (_arcTitleColor == nil) ? [UIColor greenColor] : _arcTitleColor;
        ...
        arcColor = (_arcTitleColor == nil) ? [UIColor blueColor] : _arcTitleColor;
