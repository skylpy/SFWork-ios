...
- (instancetype)initWithComponentDataArray:(NSArray *)ComponentDataArray titleDataArray:(NSArray *)titleDataArray
{
    ...
    if (self)
    {
        ...
        _toolsView = [[UIView alloc] initWithFrame:CGRectMake(0, kHeight - 244, kWidth, 44)];
        ...
        rightSureBtn.frame = CGRectMake(kWidth - 54, 0, 44, 44);
        ...
        // 中间显示  label
        UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(54, 0, kWidth - 108, 44)];
        ...
        _picerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, kHeight - 200, kWidth, 200)];
...
- (void)thisWayIsDissmisssSelf
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        blockView.frame = CGRectMake(0, kHeight, kWidth, 44);
        blockPickerViwe.frame = CGRectMake(0, kHeight, kWidth, 200);
