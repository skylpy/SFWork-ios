...
@interface SFDateTimePickerView ()<UIPickerViewDataSource, UIPickerViewDelegate>
{
    NSInteger yearRange;
    NSInteger dayRange;
    NSInteger startYear;
...
@implementation SFDateTimePickerView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, screenHeight, screenWith, 270)];
        contentV.backgroundColor = [UIColor whiteColor];
        [self addSubview:contentV];
        self.contentV = contentV;
        
        SelectTimeView * selectView = [SelectTimeView shareSelectTimeView];
        selectView.frame = CGRectMake(0, 40, screenWith, 50);
        self.selectView = selectView;
        [contentV addSubview:selectView];
        
        self.startTime = @"";
        self.endTime = @"";
        self.pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 90, [UIScreen mainScreen].bounds.size.width, 180)];
        ...
        [cancelButton setTitleColor:Color(@"#999999") forState:UIControlStateNormal];
        ...
        [chooseButton setTitleColor:Color(@"#333333") forState:UIControlStateNormal];
...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    if (self.selectView.startButton.isSelected) {
        self.startTime = _string;
        [self.selectView.startButton setTitle:_string forState:UIControlStateNormal];
        [self.selectView.startButton setTitle:_string forState:UIControlStateSelected];
    }
    
    if (self.selectView.endButton.isSelected) {
        self.endTime = _string;
        [self.selectView.endButton setTitle:_string forState:UIControlStateNormal];
        [self.selectView.endButton setTitle:_string forState:UIControlStateSelected];
    }
}
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        _contentV.frame = CGRectMake(0, screenHeight-270, screenWith, 270);
...
- (void)hideDateTimePickerView{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.alpha = 0;
        _contentV.frame = CGRectMake(0, screenHeight, screenWith, 270);
    } completion:^(BOOL finished) {
...
-(void)configButtonClick
{
    ...
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickFinishDateTimePickerViewStart:withEnd:)]) {
        [self.delegate didClickFinishDateTimePickerViewStart:self.startTime withEnd:self.endTime];
    }
