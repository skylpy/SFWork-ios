...
@interface SFFinanciaDetailViewController ()<UITableViewDelegate,UITableViewDataSource,SFExpenseCellDelegate,SFSuperSuborViewControllerDelagete,SFPhotoSelectCellDelegate,PickerToolDelegate,SFSelectPersonCellDelegate>
...
@implementation SFFinanciaDetailViewController
...
//    [self.dataArray addObjectsFromArray:[SFBillSearchModel shareShowItemArray]];
...
- (void)requestDateil{
    ...
    [SFFinancialApprovalHttpModel getFinancialApprovalDateil:self.f_id success:^(SFFinancialModel * _Nonnull model) {
        ...
        if (self.fType == FinancialApprovalType) {
            ...
            [self.dataArray addObjectsFromArray:[SFBillSearchModel shareShowItemArray:model]];
