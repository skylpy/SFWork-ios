//
//  SFOvertimeApplicationViewController.m
//  SFWork
//
...
@interface SFOvertimeApplicationViewController ()<UITableViewDelegate,UITableViewDataSource,DateTimePickerViewDelegate,SFPhotoSelectCellDelegate,PickerToolDelegate,SFPickerViewDelegate>
...
@implementation SFOvertimeApplicationViewController
...
- (void)initData {
    ...
    [self.dataArray addObjectsFromArray:[SFMyAttendanceModel shareMyAttendanceOvertimeModelModel]];
...
- (UIButton *)saveButton{
    ...
    if (!_saveButton) {
        ...
        [[_saveButton rac_signalForControlEvents:UIControlEventTouchUpInside] subscribeNext:^(__kindof UIControl * _Nullable x) {
            ...
            NSMutableDictionary * dict = [SFMyAttendanceModel pramMyOvertimeJson:self.dataArray];
