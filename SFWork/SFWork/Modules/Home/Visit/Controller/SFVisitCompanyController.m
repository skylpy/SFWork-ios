...
@interface SFVisitCompanyController ()<UITableViewDelegate,UITableViewDataSource,TFDropDownMenuViewDelegate>
...
@implementation SFVisitCompanyController
...
- (void)setDrawUI {
    ...
    NSMutableArray *array2 = [NSMutableArray arrayWithObjects: @"商家拜访数", @"客户拜访数",@"拜访总数", nil];
