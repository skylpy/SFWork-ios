//
//  SFDepStatisticeViewController.m
//  SFWork
//
...
#import "SFDepStatisticeViewController.h"
...
@interface SFDepStatisticeViewController ()<UITableViewDelegate,UITableViewDataSource,TFDropDownMenuViewDelegate>
...
@implementation SFDepStatisticeViewController
...
- (void)requestDatat {
    ...
    [SFDataReportHttpModel statisticsDataReport:dict success:^(SFStatisticsModel * _Nonnull model) {
        ...
        StatisticsList * smodel = model.statisticsDatas.firstObject;
...
- (void)setDrawUI {
    ...
    self.departmentId = [SFInstance shareInstance].userInfo.departmentId;
    self.timeCycle = @"WEEK";
